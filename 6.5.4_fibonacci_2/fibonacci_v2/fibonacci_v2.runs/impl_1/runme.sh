...
HD_PWD='C:/Users/okhac/Documents/fpga_prototyping_by_sv_examples/6.5.4_fibonacci_2/fibonacci_v2/fibonacci_v2.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log fibonacci_v2.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source fibonacci_v2.tcl -notrace
