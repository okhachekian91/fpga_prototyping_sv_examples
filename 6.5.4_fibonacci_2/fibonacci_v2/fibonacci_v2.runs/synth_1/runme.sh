...
HD_PWD='C:/Users/okhac/Documents/fpga_prototyping_by_sv_examples/6.5.4_fibonacci_2/fibonacci_v2/fibonacci_v2.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log fibonacci_v2.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source fibonacci_v2.tcl
